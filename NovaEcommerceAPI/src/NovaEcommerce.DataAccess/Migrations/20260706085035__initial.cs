        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MemberTier = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentCardTypeSnapshot = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    PaymentLastFourSnapshot = table.Column<string>(type: "nvarchar(4)", maxLength: 4, nullable: true),
                    ...
                    EstimatedDeliveryStart = table.Column<DateTime>(type: "datetime2", nullable: true),
                    EstimatedDeliveryEnd = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColorSnapshot = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    SizeSnapshot = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExchangeSize = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FitRating = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    Photos = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlashSaleItems_FlashSaleId_ProductVariantId",
                table: "FlashSaleItems",
                columns: new[] { "FlashSaleId", "ProductVariantId" },
                unique: true);
